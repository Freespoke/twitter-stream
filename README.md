...
Forked from [Fallenstedt/twitter-stream](https://github.com/Fallenstedt/twitter-stream)

![go twitter](./go-twitter.png)

[![v2](https://img.shields.io/endpoint?url=https%3A%2F%2Ftwbadges.glitch.me%2Fbadges%2Fv2)](https://developer.twitter.com/en/docs/twitter-api)
[![Go Report Card](https://goreportcard.com/badge/dev.freespoke.com/twitter-stream)](https://goreportcard.com/report/dev.freespoke.com/twitter-stream)
[![Go Reference](https://pkg.go.dev/badge/dev.freespoke.com/twitter-stream.svg)](https://pkg.go.dev/dev.freespoke.com/twitter-stream)
...
- See [examples](https://dev.freespoke.com/twitter-stream/tree/master/example) to start adding your own rules and start streaming.

![example of twit stream](./example.gif)

## Installation

`go get dev.freespoke.com/twitter-stream`


## Examples

See [examples](https://dev.freespoke.com/twitter-stream/tree/master/example), or follow the guide below.
